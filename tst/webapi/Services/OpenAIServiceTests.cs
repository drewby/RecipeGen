...
public class OpenAIServiceTests
{
  ...
  public void Constructor_NoConfig_ThrowsArgumentNullException()
  {
    ...
    var parsingService = new Mock<IParsingService>().Object;

    // Act
    var exception = Record.Exception(() => new OpenAIService(_logger, null!, promptService, parsingService));
  ...
  public void Constructor_NoOpenApiKey_ThrowsConfigException()
  {
    ...
    // Act
    var exception = Record.Exception(() => new OpenAIService(_logger, configurationMock.Object, promptService, parsingService));
  ...
  public void GenerateRecipeAsync_Returns_RecipeResponse()
  {
    ...
    var openAIService = new OpenAIService(_logger, configuration, promptServiceMock.Object, parsingService);
  ...
  public void GenerateRecipeAsync_InvalidResponse_Sets_ErrorMessage()
  {
    ...
    var parsingServiceMock = new Mock<IParsingService>();
    parsingServiceMock.Setup(service => service.ParseRecipeResponse(It.IsAny<string>())).Throws<ParsingException>();
    var openAIClientMock = new Mock<IOpenAIClientWrapper>();
    openAIClientMock.Setup(client => client.GetChatCompletionsAsync(It.IsAny<string>(), It.IsAny<ChatCompletionsOptions>()))
        .ReturnsAsync(new ChatCompletionResult()
        {
    ...
    var openAIService = new OpenAIService(_logger, configuration, promptServiceMock.Object, parsingServiceMock.Object);
    openAIService._openAIClient = openAIClientMock.Object;
