...
public class OpenAIService : IGenerativeAIService
{
    ...
    public OpenAIService(ILogger<OpenAIService> logger, IConfiguration config, IPromptService promptService)
    {
    ...
    public async Task<RecipeResponse> GenerateRecipeAsync(string modelName, RecipeRequest request)
    {
        ...
        try
        {
            ...
            {
                Recipe = _deserializer.Deserialize<Recipe>(response.Content),
